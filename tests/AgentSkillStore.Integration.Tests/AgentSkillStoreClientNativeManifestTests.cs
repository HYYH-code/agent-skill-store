// -----------------------------------------------------------------------
// <copyright file="AgentSkillStoreClientNativeManifestTests.cs" company="Petabridge, LLC">
...
public sealed class AgentSkillStoreClientNativeManifestTests
{
    private readonly AgentSkillStoreFixture _fixture;

    public AgentSkillStoreClientNativeManifestTests(AgentSkillStoreFixture fixture)
    {
        _fixture = fixture;
    }
