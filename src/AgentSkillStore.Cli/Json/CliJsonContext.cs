...
[JsonSerializable(typeof(SkillBridgeRecord))]
[JsonSerializable(typeof(SkillBridgeSummary))]
[JsonSerializable(typeof(IReadOnlyList<SkillBridgeSummary>))]
[JsonSerializable(typeof(SkillStoreLockFile))]
[JsonSerializable(typeof(SkillStoreLockEntry))]
[JsonSerializable(typeof(SkillDoctorFinding))]
[JsonSerializable(typeof(IReadOnlyList<SkillDoctorFinding>))]
[JsonSerializable(typeof(SkillMigrationItem))]
[JsonSerializable(typeof(IReadOnlyList<SkillMigrationItem>))]
