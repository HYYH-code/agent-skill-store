...
internal static class PublishSubAgentsCommand
{
    ...
    {
        Console.WriteLine("Usage: skillstore publish-subagents <path> [options]");
        Console.WriteLine();
        Console.WriteLine("Batch-publish all Agent Skill Store-compatible sub-agent markdown files under <path>.");
