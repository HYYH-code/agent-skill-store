...
internal static class PublishSubAgentCommand
{
    ...
    {
        Console.WriteLine("Usage: skillstore publish-subagent <path> --version <version> [options]");
        Console.WriteLine();
        Console.WriteLine("Publish a single Agent Skill Store-compatible sub-agent markdown file to the server.");
        Console.WriteLine();
        Console.WriteLine("Arguments:");
        Console.WriteLine("  <path>                Path to agent.md or another .md sub-agent definition");
        Console.WriteLine();
        Console.WriteLine("Options:");
        Console.WriteLine("  --version <version>   Agent Skill Store publication version (required)");
