...
internal static class LintCommand
{
    ...
    {
        Console.WriteLine("Usage: skillstore lint <path>");
        Console.WriteLine();
    ...
    {
        Console.WriteLine("Usage: skillstore lint subagent <path>");
        Console.WriteLine();
        Console.WriteLine("Validate a Agent Skill Store-compatible sub-agent markdown file.");
        Console.WriteLine();
        Console.WriteLine("Arguments:");
        ...
        Console.WriteLine("  - Name format matches Agent Skill Store resource names");
    ...
    {
        Console.WriteLine("Usage: skillstore lint subagents <path>");
        Console.WriteLine();
        Console.WriteLine("Validate all Agent Skill Store-compatible sub-agent markdown files under a directory.");
        Console.WriteLine();
        Console.WriteLine("Arguments:");
