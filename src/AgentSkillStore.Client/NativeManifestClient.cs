...
public sealed partial class AgentSkillStoreClient
{
    ...
    public async Task<NativeRootManifest?> GetManifestAsync(CancellationToken ct = default)
    {
        return await _httpClient.GetFromJsonAsync(
            "/manifest.json",
            AgentSkillStoreClientJsonContext.Default.NativeRootManifest,
            ct);
    }
        ...
        CancellationToken ct = default)
    {
        return await _httpClient.GetFromJsonAsync(
            ResolveHref(href),
            AgentSkillStoreClientJsonContext.Default.NativeSkillCollectionIndex,
            ct);
    }
        ...
        CancellationToken ct = default)
    {
        return await _httpClient.GetFromJsonAsync(
            ResolveHref(href),
            AgentSkillStoreClientJsonContext.Default.NativeSkillCollectionPage,
            ct);
    }
        ...
        CancellationToken ct = default)
    {
        return await _httpClient.GetFromJsonAsync(
            ResolveHref(href),
            AgentSkillStoreClientJsonContext.Default.NativeSkillIdentityIndex,
            ct);
    }
        ...
        CancellationToken ct = default)
    {
        return await _httpClient.GetFromJsonAsync(
            ResolveHref(href),
            AgentSkillStoreClientJsonContext.Default.NativeSkillVersionDetail,
            ct);
    }
        ...
        CancellationToken ct = default)
    {
        return await _httpClient.GetFromJsonAsync(
            ResolveHref(href),
            AgentSkillStoreClientJsonContext.Default.NativeSubAgentCollectionIndex,
            ct);
    }
        ...
        CancellationToken ct = default)
    {
        return await _httpClient.GetFromJsonAsync(
            ResolveHref(href),
            AgentSkillStoreClientJsonContext.Default.NativeSubAgentCollectionPage,
            ct);
    }
        ...
        CancellationToken ct = default)
    {
        return await _httpClient.GetFromJsonAsync(
            ResolveHref(href),
            AgentSkillStoreClientJsonContext.Default.NativeSubAgentIdentityIndex,
            ct);
    }
        ...
        CancellationToken ct = default)
    {
        return await _httpClient.GetFromJsonAsync(
            ResolveHref(href),
            AgentSkillStoreClientJsonContext.Default.NativeSubAgentVersionDetail,
            ct);
    }
